...
public class openCVDemo {
    public static void main(String[] args) {
        ...
        Mat source, template;
        //将文件读入为OpenCV的Mat格式
        source = Imgcodecs.imread("C:\\Users\\Malik\\Desktop\\yuantu.png");
        template = Imgcodecs.imread("C:\\Users\\Malik\\Desktop\\muban.png");
        //创建于原图相同的大小，储存匹配度
        ...
        //将结果输出到对应位置
        Imgcodecs.imwrite("C:\\Users\\Malik\\Desktop\\result.png", source);
